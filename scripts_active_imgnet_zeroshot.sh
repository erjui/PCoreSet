...
mkdir -p "./logs/zeroshot_imgnet/${dataset}/seed${seed}"

# Loop through each strategy
for strategy in "${strategies[@]}"; do
    # Define log file path
    log_file="./logs/zeroshot_imgnet/${dataset}/seed${seed}/dho_res50_zs_1shot_active_${strategy}_q${num_classes}_e20_r8.log"
