...
for dataset in "${datasets[@]}"; do
    ...
    for strategy in "${strategies[@]}"; do
        for seed in "${seeds[@]}"; do
            ...
            mkdir -p "./logs/zeroshot_others/${dataset}/${seed}"

            # Define log file path
            log_file="./logs/zeroshot_others/${dataset}/${seed}/dho_res18_zs_1shot_active_${strategy}_q${queries}_e200_r15_s${seed}.log"
            ...
            CUDA_VISIBLE_DEVICES=$current_gpu python train_active_others.py \
                ...
                --lr 0.001 \
                --root_path ./data \
                --log_dir "./logs/zeroshot_others/${dataset}/${seed}/" \
